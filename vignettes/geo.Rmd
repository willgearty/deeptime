...
<div class="figure">
<img src="geo-1.png" alt="plot of stratigraphic section with patterns using scale_fill_geopattern()" width="100%" />
</div>
...
For the pattern code (i.e., `pattern\_type`), see the "pattern numbers" in the [full pattern chart](https://ngmdb.usgs.gov/fgdc_gds/geolsymstd/fgdc-geolsym-patternchart.pdf) for the full list of options. Note that codes associated with color variants are supported but will result in the default color variant instead (usually black and white).
...
<div class="figure">
<img src="geo-2.png" alt="plot of stratigraphic section with patterns using ggpattern with defaults" width="100%" />
</div>
...
<div class="figure">
<img src="geo-3.png" alt="plot of stratigraphic section with patterns using ggpattern without defaults" width="100%" />
</div>
...
<div class="figure">
<img src="geo-4.png" alt="plot of stratigraphic section with patterns using ggpattern and colors" width="100%" />
</div>
