...
the stages of the Geologic Time Scale. Based on The ICS International
...
- color:
  ...
  the colors for each stage, according to the Commission for the
  Geological Map of the World

- lab_color:

  the label colors for each stage, either white or black, whichever has
...
<https://macrostrat.org/api/v2/defs/intervals?timescale=international%20ages>
