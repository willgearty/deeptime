...
- [`scale_color_geo()`](https://williamgearty.com/deeptime/reference/scale_geo.md)
  ...
  [`scale_discrete_geo()`](https://williamgearty.com/deeptime/reference/scale_geo.md)
  : Geological Time Scale color scales
- [`get_scale_data()`](https://williamgearty.com/deeptime/reference/get_scale_data.md)
...
- [`eons`](https://williamgearty.com/deeptime/reference/eons.md) : Eon
  data from the International Commission on Stratigraphy (v2024/12)
- [`eras`](https://williamgearty.com/deeptime/reference/eras.md) : Era
  data from the International Commission on Stratigraphy (v2024/12)
...
- [`gggeo_scale()`](https://williamgearty.com/deeptime/reference/gggeo_scale.md)
  **\[deprecated\]** :
...
- [`geom_points_range()`](https://williamgearty.com/deeptime/reference/geom_points_range.md)
  [`stat_points_range()`](https://williamgearty.com/deeptime/reference/geom_points_range.md)
...
- [`geo_pattern()`](https://williamgearty.com/deeptime/reference/geo_pattern.md)
  [`geo_grob()`](https://williamgearty.com/deeptime/reference/geo_pattern.md)
...
- [`gtable_frame2()`](https://williamgearty.com/deeptime/reference/gtable_frame2.md)
