...
This outlines how to propose a change to deeptime. These guidelines are
based on the tidyverse [contribution
guidelines](https://rstd.io/tidy-contrib).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/deeptime", fork = TRUE)`.
...
Please note that the deeptime project is released with a [Contributor
Code of Conduct](https://williamgearty.com/deeptime/CODE_OF_CONDUCT.md).
