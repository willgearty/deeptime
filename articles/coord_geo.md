...
[`?epochs`](https://williamgearty.com/deeptime/reference/epochs.md), and
[`?eras`](https://williamgearty.com/deeptime/reference/eras.md). Note
that the function assumes that age is decreasing towards the present.
...
- [Plotting phylogenies with
  timescales](https://williamgearty.com/deeptime/articles/phylogenies.md)
- [Additional ggplot coordinate
  systems](https://williamgearty.com/deeptime/articles/coord.md)
- [Plotting trait
  data](https://williamgearty.com/deeptime/articles/traits.md)
- [Plotting temporal
  data](https://williamgearty.com/deeptime/articles/time.md)
- [Plotting geological/stratigraphical
  patterns](https://williamgearty.com/deeptime/articles/time.md)
- [Combining and arranging
  plots](https://williamgearty.com/deeptime/articles/ggarrange2.md)
